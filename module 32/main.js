...
var text = document.getElementById('teksti1_id');
...
//
var text = "my school is the top 10 best schools in the world";
var regex = /[0-9]/g;
...
// pepr me gjet white space \s

var text = "Digital School is the top 10 best schools in the world";
var regex = /\s/g;
...
var text = "bestfrieend, boyfriend, girlfriend";
var regex = /end$/g;
document.getElementById("result17").innerHTML = text.match(regex);

var text = "cat, catalog, gategory";
var regex = /^cat/g;
